...
theorem dreadbury_mansion : (D : Type) -> (agatha : D) -> (butler : D) -> (charles : D) ->
    ...
    -- these three additional theorems help to fix an issue with grind
    -- that prevents it from finding local E-match pattern because of
    -- the existential within forall
